...
const navigation = {
    ...
    social: [
        {
            name: 'Facebook',
            href: 'https://www.facebook.com/GooDoc-112705137742654',
            icon: (props: any) => (
        ...
        {
            name: 'Instagram',
            href: 'https://www.instagram.com/goodoc_info/',
            icon: (props: any) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
        ...
        {
            name: 'Twitter',
            href: 'https://twitter.com/GooDoc9',
            icon: (props: any) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
...
const Footer = () => {
    return (
        <footer className="bg-primary-dark" aria-labelledby="footerHeading">
            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                ...
                <div className="border-t border-gray-200 mt-8 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-8">
                    ...
                    <form className="mt-4 sm:flex sm:max-w-md lg:mt-0">
                        ...
                        <input
                            ...
                            autoComplete="email"
                            required
                            className="appearance-none min-w-0 w-full bg-white border border-gray-300 py-2 px-4 text-base rounded-md text-gray-900 placeholder-white focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:placeholder-gray-400 sm:max-w-xs"
                ...
                <div className="border-t border-gray-200 pt-8 mt-8 flex justify-center space-x-6">
